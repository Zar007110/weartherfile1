...
class MainState extends State<Main> {
  ...
  Future<void> getWeather() async {
    ...
    final String appId = "e828cab905717a356bf7f66315e14d4d";
    var response = await http.get('https://api.openweathermap.org/data/2.5/weather?q=$searchQuery&appid=$appId&units=metric');
          ...
          Padding(
            ...
            child: Text(
              ...
              style: GoogleFonts.quicksand(
                textStyle: TextStyle(fontSize: 60, fontWeight: FontWeight.w500, color: Colors.grey[700]),
              ),
            ),
          ),
          SizedBox(
          ...
          Padding(
            ...
            child: city == null
                ? Text(
                    "Type & hit enter...",
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 30, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  )
                : Text(
                    "Weather in $city",
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 28, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  ),
          ),
          Padding(
            ...
            child: mainTemp == null
                ? Text(
                    ...
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  )
                : Text(
                    "$mainTemp" "°C",
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 33, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  ),
          ),
          Flexible(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.center,
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  ),
                ),
              ],
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  ),
                ),
              ],
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "No Internet",
                    style: GoogleFonts.quicksand(
                      textStyle: TextStyle(fontSize: 23, fontWeight: FontWeight.w500, color: Colors.grey[700]),
                    ),
                  ),
                ),
              ],
